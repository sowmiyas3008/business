...
import './Home.css';
import logo from '../../assets/logo.png';
import illus from '../../assets/illus-2.png';
import illustration from '../../assets/illustration1.png'; // Import your illustration image
...
const Home = () => {
  ...
  return (
    <div className="Ques1-container">
      ...
      <div className="left-side">
        <img src={illus} alt="" className="illus-2"/>
